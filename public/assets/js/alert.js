var vNotify = (function() {
    ...
    var options = {
      ...
      position: positionOption.bottomLeft,
      sticky: false,
      showClose: true
    };
...
var Notifier = new function () {
    ...
    return {
        notify: function (msg, msgType) {
            if(msgType == 'notifier' || msgType == null || msgType == undefined){
                vNotify.info({text:msg});
            }
            if(msgType == 'success'){
                vNotify.success({text:msg});
            }     
            if(msgType == 'err'){
                vNotify.error({text:msg});
            }                      
        },
        init: function (a, b) {
            this.main = a;
            ...
            if (this._alert == null) {
                ...
                this.main.alert = function (msg, msgType) {
                    Notifier.notify(msg, msgType)
                }
            }
        },
        shut: function () {
